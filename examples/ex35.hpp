...
class VolumeForceCoefficient : public VectorCoefficient {
 ...
 public:
  VolumeForceCoefficient(double r_, Vector &center_, Vector &force_)
      : VectorCoefficient(center_.Size()),
        r(r_),
        center(center_),
        force(force_) {}
...
class LinearElasticitySolver {
 ...
 public:
  ...
  LinearElasticitySolver(Mesh *mesh_, int order_, Coefficient *lambda_cf_,
                         Coefficient *mu_cf_);
...
GridFunction *LinearElasticitySolver::GetFEMSolution() { return u; }
...
LinearElasticitySolver::~LinearElasticitySolver() { ResetFEM(); }
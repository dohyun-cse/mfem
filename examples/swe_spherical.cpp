...
// Sample runs:
//
//       mpirun -np 4 swe -p 1 -rs 2 -rp 1 -o 1 -s 3
//       mpirun -np 4 swe -p 1 -rs 1 -rp 1 -o 3 -s 4
//       mpirun -np 4 swe -p 1 -rs 1 -rp 1 -o 5 -s 6
//       mpirun -np 4 swe -p 2 -rs 1 -rp 1 -o 1 -s 3 -mf
//       mpirun -np 4 swe -p 2 -rs 1 -rp 1 -o 3 -s 3 -mf
//
// Description:  This example code solves the compressible Shallow Water
...
//               integration, F is the Shallow Water flux function, and F̂ is the
//               numerical flux.
//
